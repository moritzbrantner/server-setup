...
test("dashboard renders important issues and setup details", () => {
  ...
  assert.match(markup, /Restart webhook/);
  assert.match(markup, /Restart webapp/);
  assert.match(markup, /Add website/);
  assert.match(markup, /Deploy website/);
  assert.match(markup, /Repository secrets/);
  assert.match(markup, /Save secret/);
  assert.match(markup, /Refresh secrets/);
  assert.match(markup, /Domain DNS/);
  assert.match(markup, /Create record/);
  assert.match(markup, /Refresh records/);
  assert.match(markup, /Save config/);
  assert.match(markup, /Discard edits/);
  assert.match(markup, /Reload from disk/);
  assert.match(markup, /Push to Main/);
  assert.match(markup, /Restart service/);
  assert.match(markup, /Retry deploy/);
  assert.match(markup, /Repair site/);
